          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2 border-t border-slate-50">
              <div>
                ...
                <input type="text" value={purchaseDate} onChange={(e) => setPurchaseDate(e.target.value)} placeholder="مثال: 1405/03/27" className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-amber-500 text-left dir-ltr" />
              </div>
              <div>
              ...
              {filteredAssets.length === 0 ? (
                ...
                filteredAssets.map(asset => (
                  <tr key={asset.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-center font-mono text-slate-500"><JalaliDate date={asset.purchaseDate} /></td>
                    ...
                    <td className="py-3 px-4 text-center font-bold text-emerald-700">
                      ...
                      <div className="text-[9px] text-slate-400 mt-1 font-normal">بروزرسانی: <JalaliDate date={asset.lastUpdatedDate} /></div>
                    </td>
