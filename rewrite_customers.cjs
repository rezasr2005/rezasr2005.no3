...
export default function CustomersTab({ customers, purchases, sales, onAddCustomer, onDeleteCustomer }: CustomersTabProps) {
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">تعریف اشخاص، شرکت‌ها، ناوگان و حساب‌های بانکی</p>
        </div>
        <button
            ...
            <>
              ...
              <div className="grid grid-cols-3 divide-x divide-x-reverse border-b border-slate-100">
                <div className="p-4 text-center">
                  <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">کل خریدهای ما (طلب ایشان)</div>
                ...
                <div className="p-4 text-center">
                  <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">کل فروش‌های ما (بدهی ایشان)</div>
                        ...
                        <div key={sale.id} className="p-3 bg-white hover:bg-slate-50 transition-colors flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-[10px] text-slate-500 mt-0.5">{sale.date} • وزن: <span className="font-mono font-semibold">{formatWeight(sale.netWeight)}</span></div>
                            </div>
                          </div>
                        ...
                        <div key={purchase.id} className="p-3 bg-white hover:bg-slate-50 transition-colors flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-[10px] text-slate-500 mt-0.5">{purchase.date} • وزن خالص: <span className="font-mono font-semibold">{formatWeight(purchase.finalWeight)}</span></div>
                            </div>
                          </div>
                          <div className="text-left">
...
fs.writeFileSync('src/components/CustomersTab.tsx', content);
